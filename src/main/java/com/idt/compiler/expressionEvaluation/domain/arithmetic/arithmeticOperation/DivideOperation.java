...
public class DivideOperation extends ArithmeticOperation {
    ...
    public DivideOperation(InstructionGenerationUseCase instructionGenerationUseCase, VariableManagementUseCase variableManagementUseCase) {
    ...
    void performOperation(Variable operand1, Variable operand2, Variable output) {
        getInstructionGenerator().div(operand1, operand2, output);
    }
