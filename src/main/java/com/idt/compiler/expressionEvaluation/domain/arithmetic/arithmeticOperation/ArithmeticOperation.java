...
public abstract class ArithmeticOperation {
    ...
    public ArithmeticOperation(InstructionGenerationUseCase instructionGenerationUseCase, VariableManagementUseCase variableManagementUseCase) {
    ...
    public abstract int performOperationAtCompileTime(int operand1, int operand2);
}
