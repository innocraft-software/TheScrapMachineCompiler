...
public class AndOperation extends BooleanOperation {
    ...
    public AndOperation(InstructionGenerationUseCase instructionGenerationUseCase, VariableManagementUseCase variableManagementUseCase) {
    ...
    void performOperation(Variable operand1, Variable operand2, Variable output) {
        getInstructionGenerator().and(operand1, operand2, output);
    }
}
