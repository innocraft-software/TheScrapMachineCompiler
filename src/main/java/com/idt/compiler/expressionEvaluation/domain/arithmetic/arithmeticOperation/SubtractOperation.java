...
public class SubtractOperation extends ArithmeticOperation {
    ...
    public SubtractOperation(InstructionGenerationUseCase instructionGenerationUseCase, VariableManagementUseCase variableManagementUseCase) {
    ...
    void performOperation(Variable operand1, Variable operand2, Variable output) {
        getInstructionGenerator().sub(operand1, operand2, output);
    }
