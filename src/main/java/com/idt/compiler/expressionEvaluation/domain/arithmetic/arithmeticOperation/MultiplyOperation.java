...
public class MultiplyOperation extends ArithmeticOperation {
    ...
    public MultiplyOperation(InstructionGenerationUseCase instructionGenerationUseCase, VariableManagementUseCase variableManagementUseCase) {
    ...
    void performOperation(Variable operand1, Variable operand2, Variable output) {
        getInstructionGenerator().mul(operand1, operand2, output);
    }
